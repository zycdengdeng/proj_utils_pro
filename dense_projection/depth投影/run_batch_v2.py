...
# -*- coding: utf-8 -*-
"""
Dense Projection - Depth投影批量处理
输出深度图：近白远黑，支持动静结合的点云投影
"""
...
def process_single_clip(clip_name, config, num_processes, threads_per_frame, project_root):
    ...
    output_paths = common_utils.get_unified_output_paths(str(output_root), clip_name, 'depth')
...
def main():
    print("\n" + "="*80)
    print("  Dense Projection - Depth投影 (深度图)")
    print("="*80)
