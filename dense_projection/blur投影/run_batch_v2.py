...
# -*- coding: utf-8 -*-
"""
Dense Projection - Blur投影批量处理
使用路侧相机着色，支持动静结合的点云投影
"""
...
def process_single_clip(clip_name, config, num_processes, threads_per_frame, project_root):
    ...
    output_paths = common_utils.get_unified_output_paths(str(output_root), clip_name, 'blur')
...
def main():
    print("\n" + "="*80)
    print("  Dense Projection - Blur投影 (路侧着色)")
    print("="*80)
