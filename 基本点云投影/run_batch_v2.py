...
# -*- coding: utf-8 -*-
"""
基本点云投影 - 批量处理工具 V2 (路侧标定版 lableRoadside)
...
def run_single_projection(args):
    """运行单个投影任务"""
    pcd_path, timestamp_ms, output_dir, roadside_calib, \
    roadside_images_folder, camera_id = args
...
def main():
    print("\n" + "="*80)
    print("🎯 基本点云投影 - 批量处理工具 V2 (路侧标定版 lableRoadside)")
